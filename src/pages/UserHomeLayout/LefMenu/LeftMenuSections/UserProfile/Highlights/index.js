  ...
  return (
    <>
      <div className="w-[940px] h-[130px] flex items-center px-8 mb-10">
        ...
        <Link>
          <div onClick={() => setHighlightsModal(true)} className="w-[125px] h-[128px] flex items-center flex-col">
      ...
      <NewHighlightsModal highlightsModal={highlightsModal} onClose={() => setHighlightsModal(false)} />
    </>
  );
};
